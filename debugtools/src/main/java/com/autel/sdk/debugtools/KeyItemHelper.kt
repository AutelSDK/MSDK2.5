...
/**
 * creating sub item list with key and keyitem list
...
object KeyItemHelper {
     ...
     * @param obj
     *
     * @return map with key and enum items list items
     */
            ...
            if (pFields != null) {
                for (field in pFields) {
                    ...
                    if (clazz.isEnum) {
                        ...
                        field[obj] =
                            getEnumData(clazz as Class<Enum<*>>, getSelectedValue(itemList))
                    } else if (isEnumList(field)) {
