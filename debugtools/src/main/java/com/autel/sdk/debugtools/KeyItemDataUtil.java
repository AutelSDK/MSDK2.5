...
public class KeyItemDataUtil {
    ...
    public static void initMeshKeyList(List<KeyItem<?, ?>> keyList) {
    ...
    public static void initDFCommonCmdKeyList(List<KeyItem<?, ?>> keyList) {
        initList(keyList, DFCommonCmdKey.class);
    }

    public static void initWifiStationCmdKeyList(List<KeyItem<?, ?>> keyList) {
        initList(keyList, WifiBaseStationKey.class);
    }
